class RestauantTimeSlotListResponseModel {
  bool? success;
  List<TimeSlotItemData>? data;

  RestauantTimeSlotListResponseModel({this.success, this.data});

  RestauantTimeSlotListResponseModel.fromJson(Map<String, dynamic> json) {
