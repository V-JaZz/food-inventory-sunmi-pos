...
class EditAllergy extends StatefulWidget {
  ...
  @override
  State<EditAllergy> createState() => _EditAllergyState();
}

class _EditAllergyState extends State<EditAllergy> {
  ...
  callEditAllergyApi() async {
    _allergyRepository.editAllergy(
     widget.id,
